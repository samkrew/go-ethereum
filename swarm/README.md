...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/samkrew/go-ethereum

    go install github.com/samkrew/go-ethereum/cmd/swarm
 ...
 * [Code review guidelines](https://github.com/samkrew/go-ethereum/wiki/Code-Review-Guidelines).
